...
const scenarios: Scenario[] = [
  ...
  },
  {
    ...
    body: [
      ...
      '',
      'The reviewer skill posts a failing `agent-review` status while that marker is present, so the',
      'PR does not auto-merge and the developer is re-triggered against a real, repeating finding.',
      '',
      'Expected result:',
