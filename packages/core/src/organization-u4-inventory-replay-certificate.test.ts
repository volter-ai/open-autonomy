...
const replayInputs = () => {
  const [raw, calculus, sourceRegistry, trusted] = valid(),
    inventory = freezeU4SourceInventory(raw, calculus, sourceRegistry, trusted),
