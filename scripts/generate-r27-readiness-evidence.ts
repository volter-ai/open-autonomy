...
const paths = [
  ...
  "bench/dev/evidence/r27-acquisition.ts",
  "bench/dev/evidence/r27-acquisition-cli.ts",
  "bench/dev/evidence/r27-acquisition.test.ts",
...
const evidence = {
  ...
  evidenceClasses: ["deterministic-model", "owned-local-canary", "external-evidence-acquisition", "external-evidence-verifier"],
  proves: [
    ...
    "external evidence can be collected through crash-safe role-separated requests whose signatures bind the campaign manifest, prerequisite response digests, and exact fragments",
  ],
  doesNotProve: [
