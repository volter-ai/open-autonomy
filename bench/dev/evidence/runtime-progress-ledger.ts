...
const REQUIRED_R28_READINESS_PATHS=["scripts/generate-r28-readiness-evidence.ts","packages/core/src/organization-canonical.ts","packages/core/src/organization-canonical.test.ts","packages/core/src/organization-improvement-loop.ts","packages/core/src/organization-improvement-loop.test.ts","packages/core/src/organization-r28-long-running-campaign.ts","packages/core/src/organization-r28-long-running-campaign.test.ts","packages/core/src/organization-r28-repository-dogfood-live.ts","packages/core/src/organization-r28-repository-dogfood-live.test.ts","packages/core/src/organization-r28-dogfood-v3.test.ts","bench/dev/evidence/r28-external-campaign.ts","bench/dev/evidence/r28-external-campaign.test.ts","bench/dev/evidence/r28-acquisition.ts","bench/dev/evidence/r28-acquisition-cli.ts","bench/dev/evidence/r28-acquisition.test.ts","bench/dev/evidence/verify-external-campaign.ts","bench/dev/evidence/verify-external-campaign.test.ts","docs/evidence/R28-ACQUISITION-SKEPTICAL-REVIEW.md","docs/evidence/R28-REPOSITORY-DOGFOOD.json"].sort();
