...
const scenarios: Scenario[] = [
  ...
  },
  {
    ...
    labels: ['manual-operator-test'],
    body: [
      'Publisher-policy fixture. Do not let PM auto-develop this issue; a maintainer runs',
      '`/agent develop` explicitly.',
      '',
      'The testbed develop session adds a forbidden `.github/workflows/*` change to the bundle for',
      'this fixture issue (see the fixture in `scripts/github-agent-session.ts`), so the publisher',
      'rejects a real forbidden edit.',
      '',
      'Expected result:',
