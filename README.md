...
R21 through R25 readiness campaigns use crash-safe, role-separated request/response collectors. Run
`bun run acquire:r21 -- <command>` through `bun run acquire:r25 -- <command>`; each CLI reports its command
