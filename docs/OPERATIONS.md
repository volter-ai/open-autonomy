...
you've looked at your board (see step 5's `policy.dispatch` allowlist for a populated tracker), unpause
with one command:
...
notices on its next check and idles, no restart needed (your local kill-switch; see step 4's stopping note).
