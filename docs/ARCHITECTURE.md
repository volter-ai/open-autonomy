...
| `docs/ORGANIZATION-IR-SPEC.md` | Normative experimental Organization IR v2 language specification and generated field semantics | independent implementers, compiler and conformance authors |
