...
// Real github backend: the runner is GitHub Actions + a model proxy (open-autonomy's model).
// launch triggers the agent's workflow; the agent runs IN the Action job. GitHub assigns the run
// id — the runner RECEIVES it (via gh run list), never invents one.
