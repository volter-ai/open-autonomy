...
export function verifyR25ReadinessEvidence(root:string,evidence:any){return verifyLateReadiness(root,evidence,"R25","machine-reviewable twin model and leakage-safe external-calibration acquisition/verifier readiness; never live calibration closure",REQUIRED_R25_READINESS_PATHS,R25_CLASSES,R25_PROVES,R25_LIMITS,R25_CLOSURE_REQUIREMENTS)}
export function verifyR26ReadinessEvidence(root:string,evidence:any){return verifyLateReadiness(root,evidence,"R26","machine-reviewable candidate-certificate acquisition and external-verifier readiness; never live optimization closure",REQUIRED_R26_READINESS_PATHS,R26_CLASSES,R26_PROVES,R26_LIMITS,R26_CLOSURE_REQUIREMENTS)}
