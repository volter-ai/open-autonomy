...
R21 through R26 readiness campaigns use crash-safe, role-separated request/response collectors. Run
`bun run acquire:r21 -- <command>` through `bun run acquire:r26 -- <command>`; each CLI reports its command
