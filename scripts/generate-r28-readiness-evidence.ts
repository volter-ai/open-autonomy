...
const paths = [
  ...
  "bench/dev/evidence/r28-acquisition.ts",
  "bench/dev/evidence/r28-acquisition-cli.ts",
  "bench/dev/evidence/r28-acquisition.test.ts",
  "docs/evidence/R28-ACQUISITION-SKEPTICAL-REVIEW.md",
...
const evidence = {
  ...
  evidenceClasses: ["deterministic-model", "owned-short-dogfood", "external-evidence-acquisition", "external-evidence-verifier"],
  proves: [
    ...
    "external campaign evidence can be accumulated as independently custodied append-only streams, externally sealed, durably resumed, and bound to an exact final validator signature",
  ],
  doesNotProve: [
