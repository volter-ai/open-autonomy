...
export const ORGANIZATION_SEMANTIC_COVERAGE: readonly SemanticCoverageEntry[] = [
  ...
  entry('NativePlanIR', 'schema organization steps authorities', 'compiler', 'implemented', 'emitted native execution plan with explicit state authority', 'P8'),
  ...
  entry('PackageFileRecord', 'path digest bytes mediaType', 'portable', 'implemented', 'content-addressed package file inventory', 'P1'),
  entry('PackageDependency', 'name version digest', 'portable', 'implemented', 'exact logical, version, and content dependency identity', 'P1'),
  entry('PackageSignature', 'algorithm keyId value covers', 'portable', 'implemented', 'signature envelope over package content identity', 'P1'),
  entry('OrganizationPackageManifest', 'schema name version root files dependencies signatures provenance', 'portable', 'implemented', 'hermetic organization module package', 'P1'),
  entry('PackageLockEntry', 'name version digest registry mirrors dependencies signerKeys', 'portable', 'implemented', 'exact registry-independent locked package selection', 'P1'),
  entry('OrganizationPackageLock', 'schema root registrySnapshot packages', 'portable', 'implemented', 'complete hermetic dependency graph lock', 'P1'),
  entry('RegistryVersionRecord', 'name version digest locations signerKeys publishedAt yankedAt revokedAt', 'portable', 'implemented', 'snapshot-bound package publication and revocation fact', 'P1'),
  entry('RegistrySnapshot', 'schema registry sequence generatedAt records revokedKeys', 'portable', 'implemented', 'content-addressed registry observation used by a lock', 'P1'),
  entry('CachedPackage', 'manifest files', 'compiler', 'implemented', 'verified package payload at the cache boundary', 'P1'),
  entry('PackageCache', 'get', 'compiler', 'implemented', 'digest-keyed offline package retrieval boundary', 'P1'),
  entry('PackageFetcher', 'fetch', 'compiler', 'implemented', 'approved-location package retrieval boundary', 'P1'),
  entry('PackageSignatureVerifier', 'verify', 'compiler', 'implemented', 'injected signature verification trust boundary', 'P1'),
  entry('LockedResolutionPolicy', 'maxPackages maxDepth maxTotalBytes maxFileBytes requireSignatures allowNetwork minimumRegistrySequence maxLockBytes maxSnapshotBytes maxManifestBytes maxFilesPerPackage maxDependenciesPerPackage maxSignaturesPerPackage maxRegistryRecords maxLocationsPerRecord', 'compiler', 'implemented', 'resolution resource and trust bounds', 'P1'),
  entry('ResolvedPackage', 'key lock manifest files provenance declarationOrigins', 'compiler', 'implemented', 'immutable integrity-checked package snapshot plus precomputed declaration provenance', 'P1'),
  entry('LockedPackageGraph', 'root packages digest', 'compiler', 'implemented', 'deterministic offline-resolved package graph', 'P1'),
