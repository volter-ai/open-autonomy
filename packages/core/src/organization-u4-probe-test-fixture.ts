...
import {createU4ProbeExtractionBridge,createU4BridgeVerifiedTriangulation} from "./organization-u4-probe-extraction-bridge";
...
export const replayInputs = () => {
  ...
  const join = freezeU4SourceBehaviorTraceJoin(
    ...
    specification=createU4AuthenticatedExtractionSpecification(inventory,trusted),
    extraction=createU4EvidenceExtraction(inventory,calculus,sourceRegistry,trusted,specification),
    bridge=createU4ProbeExtractionBridge(inventory,calculus,sourceRegistry,trusted,probeBundle,extraction,specification),
    triangulationInput={adjudications:[],gapDispositions:[]},
    qualified=createU4BridgeVerifiedTriangulation(bridge,inventory,calculus,sourceRegistry,trusted,probeBundle,extraction,specification,triangulationInput),
    bridgeEvidence={qualified,bridge,extraction,specification,triangulationInput},
    outcome: any = {
      ...
      resultDigest: computeU4FrontendReplayResultDigest(
        ...
        qualified.digest,qualified.bridgeDigest,qualified.witnessDenominatorDigest,qualified.triangulationDigest,
      ),
      receipt: "",
    };
  ...
  return { inventory, calculus, sourceRegistry, trusted, probeBundle,bridgeEvidence, outcome };
};
