...
const evidence = {
  ...
  evidenceClasses: ["deterministic-model", "owned-local-fixture", "external-evidence-verifier"],
  proves: ["eight-service campaign evidence has an exact matrix", "SLO and billing arithmetic is dimensioned and conserved", "fault RPO/RTO and recovery cuts are causal", "topology and workload choices are preregistered", "operator and authority attestations are ordered and authenticated"],
