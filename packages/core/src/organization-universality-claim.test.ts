...
test("U0 committed campaign artifact is an authentic frozen registration",()=>{
  const artifact=JSON.parse(readFileSync("docs/universality/campaign-v7/claim.json","utf8")) as FrozenUniversalityClaim;
...
test("U0 closure is machine indexed, skeptic accepted, residual-free, and advances only to U1",()=>{
  const closure=JSON.parse(readFileSync("docs/universality/campaign-v7/u0-closure.json","utf8"));
  const claim=JSON.parse(readFileSync("docs/universality/campaign-v7/claim.json","utf8")) as FrozenUniversalityClaim;
...
test("U0 verifier rejects reversed chronology and forged or surplus supersession joins",()=>{
  ...
  const oldClaim=JSON.parse(readFileSync("docs/universality/campaign-v6/claim.json","utf8")) as FrozenUniversalityClaim;
  const newClaim=JSON.parse(readFileSync("docs/universality/campaign-v7/claim.json","utf8")) as FrozenUniversalityClaim;
  const value:any=JSON.parse(readFileSync("docs/universality/campaign-v7/supersession.json","utf8")); delete value.digest;
