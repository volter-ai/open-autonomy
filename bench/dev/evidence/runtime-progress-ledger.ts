...
const REQUIRED_R22_READINESS_PATHS=["scripts/generate-r22-readiness-evidence.ts","packages/core/src/organization-canonical.ts","packages/core/src/organization-canonical.test.ts","packages/core/src/organization-benchmark-protocol.ts","packages/core/src/organization-benchmark-protocol.test.ts","packages/core/src/organization-r22-external-evidence-live.ts","packages/core/src/organization-r22-external-evidence-live.test.ts","packages/core/src/organization-r22-external-campaign.ts","packages/core/src/organization-r22-external-campaign.test.ts","packages/core/src/organization-r22-human-calibration-cli.ts","packages/core/src/generated/r22-human-calibration-study.schema.json","bench/dev/evidence/verify-external-campaign.ts","bench/dev/evidence/verify-external-campaign.test.ts","docs/evidence/R20-R28-EXTERNAL-INTAKE-SKEPTICAL-REVIEW.md"].sort();
const R22_CLASSES=["deterministic-model","owned-local-fixture","external-evidence-intake","external-evidence-verifier"],R22_PROVES=["workload partitions and signed bundle mechanics are implemented","assigned trial omission is rejected by the model","local bubblewrap fixture denies unmounted hidden files and network","simulator and real-human result labels are separated","human calibration refuses an absent or single-rater matrix","external campaign matrices, authority separation, seeded replay, causal enrollment, statistics, and cost conservation are verified","external evidence intake requires an independently attested exact trust module and emits a timestamp-bound content-addressed receipt"],R22_LIMITS=["externally trusted workload or grader custody","independently replayable custody conclusions","authority-backed human identity and consent","valid externally preregistered statistical inference","real-human calibration population coverage"],R22_CLOSURE_REQUIREMENTS=["closed R3, R4, R8, R10, R11, R14, R16, R20 and R21 dependencies","external registration, workload, environment, scorer, privacy and grader trust roots","complete replayable signed trial and custody evidence","authenticated consented rater identity-key bijection and exact rater-item matrix","preregistered estimand, blocking, uncertainty, censoring and multiplicity analysis","complete signed campaign accepted by an external R22 campaign verifier"];
