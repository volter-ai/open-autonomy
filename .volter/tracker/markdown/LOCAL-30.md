...
updatedAt: "2026-07-06T12:58:11.517Z"
...
## Acceptance Criteria
- [ ] dev/01 v1 npm pack + install the tarball into a clean directory: every CLI verb, including 'compile simple-sdlc local .', runs without ENOENT (fails today); a check:pack-smoke gate wired into 'bun run check' and prepublishOnly fails if any verb crashes from the packed artifact
  - status: pending
