...
// directly via `node`, exactly like the pre-U4 emitted `scheduler/run.mjs` was plain dependency-free
// Node. No bundler/build step is required to use this package from within the OA monorepo or a bun-based
