...
| --- | --- | --- | --- |
| `pm-clear-docs` | Small, exact docs change | PM sweep or `/agent developer` | PR opens, CI passes, review passes, native auto-merge lands the PR and closes the issue |
