...
const REQUIRED_R27_READINESS_PATHS=["scripts/generate-r27-readiness-evidence.ts","packages/core/src/organization-canonical.ts","packages/core/src/organization-canonical.test.ts","packages/core/src/organization-experiment.ts","packages/core/src/organization-experiment.test.ts","packages/core/src/organization-r27-live-canary.ts","packages/core/src/organization-r27-live-canary.test.ts","packages/core/src/organization-r27-live-canary-gate.test.ts","bench/dev/evidence/r27-external-closure.ts","bench/dev/evidence/r27-external-closure.test.ts","docs/evidence/R27-LIVE-CANARY-BUNDLE.json"].sort();
